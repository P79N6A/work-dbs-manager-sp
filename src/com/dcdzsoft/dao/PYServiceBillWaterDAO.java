...
public interface PYServiceBillWaterDAO
{
	public int insert(PYServiceBillWater obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(PYServiceBillWater obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(PYServiceBillWater obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public PYServiceBillWater find(PYServiceBillWater obj) throws EduException;
