...
public class PATerminalCtrlParamDAOImpl implements PATerminalCtrlParamDAO
{
	...
	public int insert(PATerminalCtrlParam obj) throws EduException
	{
		...
		String sql = "INSERT INTO PATerminalCtrlParam(CtrlTypeID,CtrlTypeName,KeyString,DefaultValue,LastModifyTime,Remark)VALUES(?,?,?,?,?,?)";
	...
	public int delete(PATerminalCtrlParam obj) throws EduException
	{
		...
		String sql = "DELETE FROM PATerminalCtrlParam WHERE CtrlTypeID = ?  AND KeyString = ? ";

		log.debug("[delete sql]:" + "DELETE FROM PATerminalCtrlParam WHERE CtrlTypeID = " + obj.CtrlTypeID +
	...
	public boolean isExist(PATerminalCtrlParam obj) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM PATerminalCtrlParam WHERE CtrlTypeID = ?  AND KeyString = ? ";

		log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM PATerminalCtrlParam WHERE CtrlTypeID = " + obj.CtrlTypeID +
						" AND KeyString = " + StringUtils.addQuote(obj.KeyString) );
	...
	public PATerminalCtrlParam find(PATerminalCtrlParam obj) throws EduException
	{
		...
		String sql = "SELECT CtrlTypeID,CtrlTypeName,KeyString,DefaultValue,LastModifyTime,Remark  FROM PATerminalCtrlParam WHERE CtrlTypeID = ?  AND KeyString = ? ";

		log.debug("[find sql]:" + "SELECT CtrlTypeID,CtrlTypeName,KeyString,DefaultValue,LastModifyTime,Remark  FROM PATerminalCtrlParam WHERE CtrlTypeID = " + obj.CtrlTypeID +
						" AND KeyString = " + StringUtils.addQuote(obj.KeyString) );
