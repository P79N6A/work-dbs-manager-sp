...
public class RMOpenBoxLogDAOImpl implements RMOpenBoxLogDAO
{
	...
	public int insert(RMOpenBoxLog obj) throws EduException
	{
		...
		String sql = "INSERT INTO RMOpenBoxLog(WaterID,OpenBoxUser,OpenBoxType,BoxNo,TerminalNo,PackageID,Mobile,LastModifyTime,Remark)VALUES(?,?,?,?,?,?,?,?,?)";
	...
	public RMOpenBoxLog find(RMOpenBoxLog obj) throws EduException
	{
		...
		String sql = "SELECT WaterID,OpenBoxUser,OpenBoxType,BoxNo,TerminalNo,PackageID,Mobile,LastModifyTime,Remark  FROM RMOpenBoxLog WHERE WaterID = ? ";

		log.debug("[find sql]:" + "SELECT WaterID,OpenBoxUser,OpenBoxType,BoxNo,TerminalNo,PackageID,Mobile,LastModifyTime,Remark  FROM RMOpenBoxLog WHERE WaterID = " + obj.WaterID );
