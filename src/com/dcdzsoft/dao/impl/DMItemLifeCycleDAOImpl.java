...
public class DMItemLifeCycleDAOImpl implements DMItemLifeCycleDAO
{
	private static final Log log = LogFactory.getLog(DMItemLifeCycleDAOImpl.class.getName());
	...
	public int insert(DMItemLifeCycle obj) throws EduException
	{
		PreparedStatement pstmt = null;
		int result = 0;

		String sql = "INSERT INTO DMItemLifeCycle(WaterID,PackageID,ItemStatus,StatusTime,LastStatus,ZoneID,OperatorID,OperatorType,RecordLevel,LastModifyTime,Remark)VALUES(?,?,?,?,?,?,?,?,?,?,?)";
		...
		try
		{
			...
			PreparedStmtUtils.setInt(pstmt,4,obj.StatusTime);
			PreparedStmtUtils.setString(pstmt,5,obj.LastStatus);
		...
		{
			String errorCode = ErrorCode.ERR_ADDDMITEMLIFECYCLEFAIL;
	...
	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "UPDATE DMItemLifeCycle SET ";
		...
		SQLLog.logUpdate(log,"DMItemLifeCycle",setCols,whereCols);
		...
		{
			String errorCode = ErrorCode.ERR_MODDMITEMLIFECYCLEFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(DMItemLifeCycle obj) throws EduException
	{
		PreparedStatement pstmt = null;
		int result = 0;

		String sql = "DELETE FROM DMItemLifeCycle WHERE WaterID = ? ";

		log.debug("[delete sql]:" + "DELETE FROM DMItemLifeCycle WHERE WaterID = " + obj.WaterID );
		...
		{
			String errorCode = ErrorCode.ERR_DELDMITEMLIFECYCLEFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "DELETE FROM DMItemLifeCycle WHERE 1=1 " ;
		...
		SQLLog.logDelete(log,"DMItemLifeCycle",whereCols);
	...
	public boolean isExist(DMItemLifeCycle obj) throws EduException
	{
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		...
		String sql = "SELECT COUNT(*) FROM DMItemLifeCycle WHERE WaterID = ? ";

		log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM DMItemLifeCycle WHERE WaterID = " + obj.WaterID );
		...
		{
			String errorCode = ErrorCode.ERR_QRYDMITEMLIFECYCLEFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int isExist(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM DMItemLifeCycle WHERE 1=1 " ;
		...
		SQLLog.logIsExist(log,"DMItemLifeCycle",whereCols);
	...
	public DMItemLifeCycle find(DMItemLifeCycle obj) throws EduException
	{
		DMItemLifeCycle result = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;

		String sql = "SELECT WaterID,PackageID,ItemStatus,StatusTime,LastStatus,ZoneID,OperatorID,OperatorType,RecordLevel,LastModifyTime,Remark  FROM DMItemLifeCycle WHERE WaterID = ? ";

		log.debug("[find sql]:" + "SELECT WaterID,PackageID,ItemStatus,StatusTime,LastStatus,ZoneID,OperatorID,OperatorType,RecordLevel,LastModifyTime,Remark  FROM DMItemLifeCycle WHERE WaterID = " + obj.WaterID );
		...
		try
		{
			...
			{
				throw new EduException(ErrorCode.ERR_DMITEMLIFECYCLENODATA);
			}
		}
		catch(SQLException e)
		{
	...
	public RowSet select(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT * FROM DMItemLifeCycle WHERE 1=1 ";
	...
	public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT " + fName + " FROM DMItemLifeCycle WHERE 1=1 ";
