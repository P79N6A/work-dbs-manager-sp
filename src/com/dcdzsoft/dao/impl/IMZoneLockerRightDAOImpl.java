...
public class IMZoneLockerRightDAOImpl implements IMZoneLockerRightDAO
{
	private static final Log log = LogFactory.getLog(IMZoneLockerRightDAOImpl.class.getName());
	...
	public int insert(IMZoneLockerRight obj) throws EduException
	{
		PreparedStatement pstmt = null;
		int result = 0;

		String sql = "INSERT INTO IMZoneLockerRight(ZoneID,TerminalNo,Remark)VALUES(?,?,?)";
		...
		{
			String errorCode = ErrorCode.ERR_ADDIMZONELOCKERRIGHTFAIL;
	...
	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "UPDATE IMZoneLockerRight SET ";
		...
		SQLLog.logUpdate(log,"IMZoneLockerRight",setCols,whereCols);
		...
		{
			String errorCode = ErrorCode.ERR_MODIMZONELOCKERRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(IMZoneLockerRight obj) throws EduException
	{
		PreparedStatement pstmt = null;
		int result = 0;

		String sql = "DELETE FROM IMZoneLockerRight WHERE ZoneID = ?  AND TerminalNo = ? ";

		log.debug("[delete sql]:" + "DELETE FROM IMZoneLockerRight WHERE ZoneID = " + StringUtils.addQuote(obj.ZoneID) +
		...
		{
			String errorCode = ErrorCode.ERR_DELIMZONELOCKERRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int delete(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "DELETE FROM IMZoneLockerRight WHERE 1=1 " ;
		...
		SQLLog.logDelete(log,"IMZoneLockerRight",whereCols);
	...
	public boolean isExist(IMZoneLockerRight obj) throws EduException
	{
		PreparedStatement pstmt = null;
		ResultSet rset = null;
		...
		String sql = "SELECT COUNT(*) FROM IMZoneLockerRight WHERE ZoneID = ?  AND TerminalNo = ? ";

		log.debug("[isExist sql]:" + "SELECT COUNT(*) FROM IMZoneLockerRight WHERE ZoneID = " + StringUtils.addQuote(obj.ZoneID) +
						" AND TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) );
		...
		{
			String errorCode = ErrorCode.ERR_QRYIMZONELOCKERRIGHTFAIL;
			log.error("[DBERROR-("+ errorCode + ")]==>[sqlcode]:"+e.getErrorCode() + " [errmsg]:"+e.getMessage() + " [sql]:"+sql);
			throw new EduException(errorCode);
		}
		finally
	...
	public int isExist(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT COUNT(*) FROM IMZoneLockerRight WHERE 1=1 " ;
		...
		SQLLog.logIsExist(log,"IMZoneLockerRight",whereCols);
	...
	public IMZoneLockerRight find(IMZoneLockerRight obj) throws EduException
	{
		IMZoneLockerRight result = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;

		String sql = "SELECT ZoneID,TerminalNo,Remark  FROM IMZoneLockerRight WHERE ZoneID = ?  AND TerminalNo = ? ";

		log.debug("[find sql]:" + "SELECT ZoneID,TerminalNo,Remark  FROM IMZoneLockerRight WHERE ZoneID = " + StringUtils.addQuote(obj.ZoneID) +
						" AND TerminalNo = " + StringUtils.addQuote(obj.TerminalNo) );
		...
		try
		{
			...
			{
				throw new EduException(ErrorCode.ERR_IMZONELOCKERRIGHTNODATA);
			}
		}
		catch(SQLException e)
		{
	...
	public RowSet select(JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT * FROM IMZoneLockerRight WHERE 1=1 ";
	...
	public String selectFunctions(String fName,JDBCFieldArray whereCols) throws EduException
	{
		...
		String sql = "SELECT " + fName + " FROM IMZoneLockerRight WHERE 1=1 ";
