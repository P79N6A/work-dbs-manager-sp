...
public interface IMServiceRateDAO
{
	public int insert(IMServiceRate obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(IMServiceRate obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(IMServiceRate obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public IMServiceRate find(IMServiceRate obj) throws EduException;
