...
public interface IMPostalProcessingCenterDAO
{
	public int insert(IMPostalProcessingCenter obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(IMPostalProcessingCenter obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(IMPostalProcessingCenter obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public IMPostalProcessingCenter find(IMPostalProcessingCenter obj) throws EduException;
