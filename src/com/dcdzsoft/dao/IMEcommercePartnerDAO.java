...
public interface IMEcommercePartnerDAO
{
	public int insert(IMEcommercePartner obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(IMEcommercePartner obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(IMEcommercePartner obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public IMEcommercePartner find(IMEcommercePartner obj) throws EduException;
