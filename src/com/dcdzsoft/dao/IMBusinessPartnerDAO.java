...
public interface IMBusinessPartnerDAO
{
	public int insert(IMBusinessPartner obj) throws EduException;

	public int update(JDBCFieldArray setCols,JDBCFieldArray whereCols) throws EduException;

	public int delete(IMBusinessPartner obj) throws EduException; 

	public int delete(JDBCFieldArray whereCols) throws EduException; 

	public boolean isExist(IMBusinessPartner obj) throws EduException;

	public int isExist(JDBCFieldArray whereCols) throws EduException;

	public IMBusinessPartner find(IMBusinessPartner obj) throws EduException;
