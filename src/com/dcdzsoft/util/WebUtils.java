...
public class WebUtils {
    ...
    public static Object buildBussinessDTOParam(Class c,
            HttpServletRequest request,
            BusiHandlerEntity entity, JSONObject param) {
    	Object o = null;
        try {
            o = c.newInstance();
                ...
                if (typeName.equals("java.lang.String")) {
                    ...
                    if (name.equals("OperID"))
                    	...
                    	if(param.has(paramName)){
                    		value = param.getString(paramName);//getStringParameter(paramName, request);
                    	}else{
                    		value = "";
                    	}
                    ...
                    int value = 0;
                    if(param.has(paramName)){
                    	value = param.getInt(paramName);//getIntParameter(paramName, request);
                    }
                    ...
                    long value = 0;
                    if(param.has(paramName)){
                    	value = param.getLong(paramName);//getlongParameter(paramName, request);
                    }
                    ...
                    Double value = 0.0;
                    if(param.has(paramName)){
                    	value = new Double(param.getDouble(paramName));//getDoubleParameter(paramName,request)
                    }
                    Method method = c.getMethod(methodName, partypes);
                    method.invoke(o, new Object[] {value});
                } else if (typeName.equals("java.sql.Date")) {
     ...
     * @return
     */
    public static Object buildBussinessDTOParamOut(Class c, javax.sql.RowSet rset) {
    	Object o = null;
        try {
            o = c.newInstance();
            ...
            for (int i = 0; i < fields.length; i++) {
                ...
                String typeName = type.getName();
                if (typeName.equals("java.lang.String")) {
                    String value = getStringParameter(paramName, rset);
                    if (StringUtils.isNotEmpty(value)) {
                        Method method = c.getMethod(methodName,
                                new Class[] {String.class});
                        method.invoke(o, new Object[] {value});
                    ...
                    int value = getIntParameter(paramName, rset);
                    Class partypes[] = new Class[1];
                    partypes[0] = Integer.TYPE;
                    Method method = c.getMethod(methodName, partypes);
                    method.invoke(o, new Object[] {new Integer(value)});
                } else if (typeName.equals("long")) {
                    long value = getlongParameter(paramName, rset);
                    ...
                    Double value = new Double(getDoubleParameter(paramName,rset));
                    Method method = c.getMethod(methodName, partypes);
                    method.invoke(o, new Object[] {value});
                } else if (typeName.equals("java.sql.Date")) {
                	java.sql.Date value = getDateParameter(paramName, rset);
                	...
                	java.sql.Timestamp value = getTimestampParameter(paramName, rset);
    ...
    public static String getStringParameter(String name,
		...
		if (rset != null) {
			try {
				value = StringUtils.trimToEmpty(RowSetUtils.getStringValue(rset, name));
    ...
    public static int getIntParameter(String name, javax.sql.RowSet rset) {
        int value = 0;
        if (rset != null) {
        	try {
				value = RowSetUtils.getIntValue(rset, name);
			} catch (EduException e) {
				// TODO Auto-generated catch block
				//e.printStackTrace();
			}
    ...
    public static long getlongParameter(String name, javax.sql.RowSet rset) {
    	long value = 0;
        if (rset != null) {
        	try {
				value = RowSetUtils.getLongValue(rset, name);
			} catch (EduException e) {
				// TODO Auto-generated catch block
				//e.printStackTrace();
			}
    ...
    public static double getDoubleParameter(String name, javax.sql.RowSet rset) {
    	double value = 0.0D;
        if (rset != null) {
        	try {
				value = RowSetUtils.getDoubleValue(rset, name);
			} catch (EduException e) {
				// TODO Auto-generated catch block
				//e.printStackTrace();
			}
    ...
    public static java.sql.Date getDateParameter(String name, javax.sql.RowSet rset) {
    	java.sql.Date value = null;
        if (rset != null) {
        	try {
				value = RowSetUtils.getDateValue(rset, name);
			} catch (EduException e) {
				// TODO Auto-generated catch block
				//e.printStackTrace();
			}
    ...
    public static java.sql.Timestamp getTimestampParameter(String name, javax.sql.RowSet rset) {
    	java.sql.Timestamp value = null;
        if (rset != null) {
        	try {
				value = RowSetUtils.getTimestampValue(rset, name);
			} catch (EduException e) {
				// TODO Auto-generated catch block
				//e.printStackTrace();
			}
