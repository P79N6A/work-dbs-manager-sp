...
public class DMDeliveryAssign extends ActionBean
{

    public int doBusiness(InParamDMDeliveryAssign in) throws EduException
    {
        ...
        int postmanRight = commonDAO.getPostmanRight(postman);
