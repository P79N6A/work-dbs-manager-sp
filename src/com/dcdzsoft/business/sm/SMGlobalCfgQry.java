...
public class SMGlobalCfgQry extends ActionBean {
    ...
    public RowSet doBusiness(InParamSMGlobalCfgQry in) throws EduException {
       ...
       dRow.addStrColumn("gatewayUser", 64);
       dRow.addStrColumn("gatewayPwd", 30);
       dRow.addStrColumn("mbHost", 32);
       dRow.addStrColumn("mbPort", 10);
       dRow.addStrColumn("mbUri", 64);
       dRow.addStrColumn("imgServerUri", 64);//add by zxy
       dRow.addStrColumn("ftpHost", 32);
       dRow.addStrColumn("ftpPort", 10);
       dRow.addStrColumn("ftpUser", 64);
       dRow.addStrColumn("ftpPasswd", 32);

       dRow.addStrColumn("emailServerHost", 32);
       dRow.addStrColumn("emailServerPort", 10);
       dRow.addStrColumn("emailUser", 64);
       dRow.addStrColumn("emailPwd", 32);
       dRow.addStrColumn("emailAddress", 64);
       ...
       fArray.addCol("imgServerUri", apCfg.getImgServerUri());
       ...
       fArray.addCol("emailServerHost", apCfg.getEmailServerHost());
       fArray.addCol("emailServerPort", apCfg.getEmailServerPort());
       fArray.addCol("emailUser", apCfg.getEmailUser());
       fArray.addCol("emailPwd", apCfg.getEmailPwd());
       fArray.addCol("emailAddress", apCfg.getEmailAddress());
