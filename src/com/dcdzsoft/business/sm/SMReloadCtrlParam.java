...
public class SMReloadCtrlParam extends ActionBean {
    ...
    public int doBusiness(InParamSMReloadCtrlParam in) throws EduException {
        ...
        //原ApplicationConfig移入DB中的ControlParam表中
        String sql1 = "SELECT * FROM PAControlParam WHERE CtrlTypeID = '11041'";
        RowSet rset1 = dbSession.executeQuery(sql1);
        GServer.getInstance().loadApplicationConfigToMemory(rset1);
