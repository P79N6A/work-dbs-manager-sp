...
public class QYOperationReportByPackCount extends ActionBean
{

    public int doBusiness(InParamQYOperationReportByPackCount in) throws EduException
    {
...
//		if("1".equals(in.StatFlag)){//2:按操作员UserID统计
