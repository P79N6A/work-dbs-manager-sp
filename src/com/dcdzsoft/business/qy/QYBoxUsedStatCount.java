...
public class QYBoxUsedStatCount extends ActionBean
{
    ...
    public int doBusiness(InParamQYBoxUsedStatCount in) throws EduException
    {
		...
		String sql = "SELECT TerminalNo,TerminalName,Location  FROM  V_TBBoxStat a WHERE 1=1 "
				+ whereSQL.getPreparedWhereSQL() + limitSQL + " GROUP BY TerminalNo,TerminalName,Location  ";
