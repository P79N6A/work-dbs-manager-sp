...
public class QYCompanyBoxUsage extends ActionBean
{

    public RowSet doBusiness(InParamQYCompanyBoxUsage in) throws EduException
    {
        ...
        String sql = "SELECT * FROM V_QYServiceOwnerBoxUsage  WHERE 1=1 " + whereSQL.getPreparedWhereSQL() ;
        
        java.util.LinkedList list = new java.util.LinkedList();
        list.add("CompanyID,TakedTime ASC");
