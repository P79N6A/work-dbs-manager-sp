...
public class IMPPCQry extends ActionBean
{

    public RowSet doBusiness(InParamIMPPCQry in) throws EduException
    {
        ...
        String sql = "SELECT * FROM V_IMPPC WHERE 1=1 " + whereSQL.getPreparedWhereSQL() +limitsql
        		+ "";// ORDER BY PPCID
        
        java.util.List<String> orderByField = new java.util.LinkedList<String>();
        orderByField.add("PPCID ASC");
