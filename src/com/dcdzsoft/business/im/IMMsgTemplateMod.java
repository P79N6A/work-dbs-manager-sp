...
public class IMMsgTemplateMod extends ActionBean
{

    public int doBusiness(InParamIMMsgTemplateMod in) throws EduException
    {
		...
		if (StringUtils.isEmpty(in.OperID)
			||StringUtils.isEmpty(in.TemplateID)
        ...
        whereCols0.add("GatewayID", "<>", in.TemplateID);
        ...
        setCols.add("GatewayName", in.TemplateName);
        setCols.add("SMSTemplate", in.SMSTemplate);
        setCols.add("EmailTemplate", in.EmailTemplate);
        setCols.add("TemplateType", in.TemplateType);
        setCols.add("LastModifyTime", sysDateTime);
        setCols.add("Remark", in.Remark);

        whereCols.add("GatewayID", in.TemplateID);
