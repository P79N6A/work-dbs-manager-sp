...
public class IMCompanyQry extends ActionBean
{

    public RowSet doBusiness(InParamIMCompanyQry in) throws EduException
    {
        ...
        String sql = "SELECT * FROM V_IMCompany WHERE 1=1 " + limitsql+ whereSQL.getPreparedWhereSQL();
        
        java.util.List<String> orderByField = new java.util.LinkedList<String>();
        orderByField.add("CompanyID ASC");
