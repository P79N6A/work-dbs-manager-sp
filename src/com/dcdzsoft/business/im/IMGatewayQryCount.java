...
public class IMGatewayQryCount extends ActionBean
{

    public int doBusiness(InParamIMGatewayQryCount in) throws EduException
    {
        ...
        String sql = "SELECT COUNT(GatewayID) FROM V_IMSMSGateway WHERE 1=1 " + whereSQL.getPreparedWhereSQL() + limitsql;
