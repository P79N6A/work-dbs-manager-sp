...
public class IMEmailAccountQryCount extends ActionBean
{

    public int doBusiness(InParamIMEmailAccountQryCount in) throws EduException
    {
        ...
        String sql = "SELECT COUNT(EmailID) FROM V_IMEmailAccount WHERE 1=1 " + whereSQL.getPreparedWhereSQL() + limitsql;
