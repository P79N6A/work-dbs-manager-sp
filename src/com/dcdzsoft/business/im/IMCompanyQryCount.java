...
public class IMCompanyQryCount extends ActionBean
{

    public int doBusiness(InParamIMCompanyQryCount in) throws EduException
    {
        ...
        String sql = "SELECT COUNT(CompanyID) FROM V_IMCompany WHERE 1=1 "+ limitsql + whereSQL.getPreparedWhereSQL() ;
