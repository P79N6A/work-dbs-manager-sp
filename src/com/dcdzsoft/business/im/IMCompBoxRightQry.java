...
public class IMCompBoxRightQry extends ActionBean
{

    public RowSet doBusiness(InParamIMCompBoxRightQry in) throws EduException
    {
		...
		String selectsql = "SELECT TerminalNo, TerminalName, BoxNo, BoxName, BoxType, BoxTypeName "//Location, Address, 
				+ " FROM V_TBBox a ";
