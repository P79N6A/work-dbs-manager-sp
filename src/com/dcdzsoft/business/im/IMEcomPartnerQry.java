...
public class IMEcomPartnerQry extends ActionBean
{

    public RowSet doBusiness(InParamIMEcomPartnerQry in) throws EduException
    {
        ...
        String sql = "SELECT * FROM V_IMEcomPartner WHERE 1=1 " + whereSQL.getPreparedWhereSQL() + limitsql
        		+"";// ORDER BY EPartnerID
        
        java.util.List<String> orderByField = new java.util.LinkedList<String>();
        orderByField.add("EPartnerID ASC");
