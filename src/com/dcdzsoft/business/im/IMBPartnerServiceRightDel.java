...
public class IMBPartnerServiceRightDel extends ActionBean
{

    public int doBusiness(InParamIMBPartnerServiceRightDel in) throws EduException
    {
		...
		if(StringUtils.isEmpty(in.servicesList)){
	    	...
	    	for(String serviceID: serviceArray){
	    		...
	    		serviceRightDAO.delete(serviceRight);
	    	}
		}
