...
public class IMMsgTemplateQryCount extends ActionBean
{

    public int doBusiness(InParamIMMsgTemplateQryCount in) throws EduException
    {
        ...
        String sql = "SELECT COUNT(TemplateID) FROM V_IMMsgTemplate WHERE 1=1 " + whereSQL.getPreparedWhereSQL() + limitsql;
