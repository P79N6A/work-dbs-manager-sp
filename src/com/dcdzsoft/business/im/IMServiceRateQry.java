...
public class IMServiceRateQry extends ActionBean
{

    public RowSet doBusiness(InParamIMServiceRateQry in) throws EduException
    {
        ...
        String sql = "SELECT * FROM V_IMServiceType WHERE 1=1 " + whereSQL.getPreparedWhereSQL() 
        		+ "";// ORDER BY ServiceID
        
        //rset = dbSession.executeQuery(sql,whereSQL);
        java.util.List<String> orderByField = new java.util.LinkedList<String>();
        orderByField.add("ServiceID ASC");
