...
public class PTPrintMissing extends ActionBean
{

    public OutParamPrintData doBusiness(InParamPTPrintMissing in) throws EduException
    {
    	...
    	whereCols0.add("ItemStatus", SysDict.ITEM_STATUS_DROP_MISSING);
        ...
        while (RowSetUtils.rowsetNext(rset)) {
        	...
        	itemBean.setRemark(CustomerMobile);
