...
public class PTManagerPickupPack extends ActionBean
{
    ...
    public OutParamPTManagerPickupPack doBusiness(InParamPTManagerPickupPack in) throws EduException
    {
        ...
        historyPack.ItemStatus = SysDict.ITEM_STATUS_DROP_TAKEOUT;//管理员协助客户取件，SysDict.ITEM_STATUS_DROP_INTRANSIT_BACK
        historyPack.RunStatus  = SysDict.ITEM_RUN_STATUS_TAKEOUT_MANAGER;
        ...
        //"ManagerTakeout("+historyPack.TerminalNo+"-"+historyPack.BoxNo+")"
        String[] itemDesc= {historyPack.TerminalNo,historyPack.BoxNo};
        ...
        itemLifeCycle.OperatorType  = SysDict.OPER_TYPE_SPOT;
        ...
        commonDAO.addItemLifeCycle(Constant.ACTION_CODE_PICKUPBYMANAGER, itemLifeCycle, itemDesc);

        //#start 订单数据加入发送队列进行发送(状态更新)
    	commonDAO.addItemStatusUpdate(historyPack.PPCID, historyPack.ItemStatus, historyPack, SysDict.TRANSFER_TYPE_TAKEOUT_BY_MANAGER);
        //#end
		...
		setCols2.add("PackageStatus", historyPack.ItemStatus);
    ...
    private void feedback(PTDeliverHistory historyPack){
        ...
        if(StringUtils.isNotEmpty(ApplicationConfig.getInstance().getEmailAddress())){
            String tacktype = "PickUp by Manager";
