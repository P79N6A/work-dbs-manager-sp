...
public class PTPrintRedistribute extends ActionBean
{

    public OutParamPrintData doBusiness(InParamPTPrintRedistribute in) throws EduException
    {
