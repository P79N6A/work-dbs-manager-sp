...
public class  OPWebClientAdapter
{
	...
	public static javax.sql.RowSet doBusiness() throws com.dcdzsoft.EduException
	{
		BusiBeanAOPBaseClass aop = BusiBeanAOPBaseClass.getInstance();
		com.dcdzsoft.business.tb.TBTerminalPie bean = ( com.dcdzsoft.business.tb.TBTerminalPie)aop.bind(com.dcdzsoft.business.tb.TBTerminalPie.class);
		return bean.doBusiness();
	}
	/**
	 * 
	 * @param OperID
	 * @param intType 0-柜状态统计;1-箱状态统计;2-按箱尺寸统计箱数量
	 * @return
	 * @throws com.dcdzsoft.EduException
	 */
	public static javax.sql.RowSet doBusiness(String OperID, int intType) throws com.dcdzsoft.EduException
	{
		BusiBeanAOPBaseClass aop = BusiBeanAOPBaseClass.getInstance();
		com.dcdzsoft.business.tb.ParcelInfoQry bean = ( com.dcdzsoft.business.tb.ParcelInfoQry)aop.bind(com.dcdzsoft.business.tb.ParcelInfoQry.class);
		return bean.doBusiness(OperID, intType);
	}
}
