...
public class SequenceGenerator {
    ...
    public static final String SEQ_ITEMWATERID = "SeqItemWaterID"; //订单流水编号
    public static final String SEQ_ITEMTRANSFERWATERID = "SeqItemTransferWaterID"; //transfer订单流水编号
    public static final String SEQ_TRANSFERWATERID = "SeqTransferWaterID"; //transfer发送流水编号
