...
public class InParamDMDeliveryQryCount implements java.io.Serializable
{
	public String FunctionID = "341015"; //功能编号

	public String OperID = ""; //管理员编号
	public String QryFlag = ""; //查询标识（1-操作员查询，2-揽件员查询）
